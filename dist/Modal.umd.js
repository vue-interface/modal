...
var ModalFactory_ModalFactory = /*#__PURE__*/function () {
  ...
  _createClass(ModalFactory, [{
    key: "register",
    value: function register(key, _ref) {
      var _this = this;

      var _render = _ref.render,
          resolver = _ref.resolver;
      return this[key] = function (title, content) {
        var ModalWrapper = _this.$vue.extend({
          render: function render(h) {
            return _render(h, title, content);
          }
        });

        var wrapper = new ModalWrapper({
        ...
        if (isFunction(resolver)) {
          ...
          return resolver.apply(void 0, [wrapper].concat(args));
        }
...
function ModalPlugin_component(type) {
  return {
    resolver: function resolver(wrapper, validate) {
